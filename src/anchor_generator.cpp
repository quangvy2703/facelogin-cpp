...
int AnchorGenerator::FilterAnchor(NDArray& cls, NDArray& reg, NDArray& pts, std::vector<Anchor>& result) {
    assert(cls.GetShape()[1] == anchor_num*2);
    assert(reg.GetShape()[1] == anchor_num*4);
    int pts_length = 0;
